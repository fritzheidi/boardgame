...
data = [{
     img: "https://i.cbc.ca/1.1588882.1379057347!/httpImage/image.jpg_gen/derivatives/16x9_620/hi-wheat-852-8col.jpg",
}, {
     img: "https://cdn0.iconfinder.com/data/icons/flat-round-system/512/android-128.png"
}, {
     img: "https://3.imimg.com/data3/GF/QP/MY-14262698/brick-field-500x500.png"
}]
...
function image() {
     var img1 = document.getElementById('image').src = "https://i.cbc.ca/1.1588882.1379057347!/httpImage/image.jpg_gen/derivatives/16x9_620/hi-wheat-852-8col.jpg";
     return img1;
}
///////////////////////////////////////////////////////////////////////////
///////////////////////////// Mouseover functions /////////////////////////
...
for (var row = 0; row < MapRows; row++) {
    if(row == 0 || row == 6){
     	...
     	truePoints.push([hexRadius * col * Math.sqrt(3), hexRadius * row * 1.5]);
         }//for col
    }
